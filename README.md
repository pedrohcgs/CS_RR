...
(2021). These are currently implemented in the `did` and `HonestDiD` `R`
packages.
...
-   [Callaway, Brantly, and Pedro H. C. Sant’Anna.
    “Difference-in-differences with multiple time periods.” Forthcoming
    at the Journal of
    Econometrics (2021)](https://authors.elsevier.com/a/1cFzc15Dji4pnC).

-   [Rambachan, Ashesh, and Jonathan Roth. “An Honest Approach to
    Parallel Trends”
    (2021).](https://jonathandroth.github.io/assets/files/HonestParallelTrends_Main.pdf)
