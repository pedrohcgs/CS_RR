...
In this vignette, we have shown that it is straightforward to combine the Callaway and Sant'Anna (2021) DiD procedures implemented in the `did` package, with the sentivity analysis proposed by Rambachan and Roth (2021) implemented in the `HonestDiD` package. 
